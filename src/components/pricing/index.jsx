  ...
  return (
    <>
      ...
      <div className="frame10">
        ...
        <Link className="my-link" to="/customers">
          Meet all customers →
        </Link>
      </div>
      ...
      <div id="images-container">
        ...
        <div className="laptop">
          <img src={Image19} alt="someone using a laptop" />
          <p className="card2">
            What are your safeguarding responsibilities and how can you manage
            them?
          </p>
          <button className="btn1">Readmore →</button>
        </div>

        <div className="mod">
          <img src={Image20} alt="someone typing" />
          <p className="card3">
            Revamping the Membership Model with Triathlon Australia
          </p>
          <button className="btn2">Readmore →</button>
        </div>

        <div className="lib">
          <h2 className="pell">Pellentesque suscipit fringilla libero eu.</h2>
